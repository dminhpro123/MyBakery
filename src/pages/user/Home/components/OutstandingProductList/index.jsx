...
const OutstandingProductList = () => {
  const dispatch = useDispatch();
  const { outstandingProductList } = useSelector((state) => state.product);
  ...
  }, [outstandingProductList.data, handleAddToCart]);
...
export default OutstandingProductList;
